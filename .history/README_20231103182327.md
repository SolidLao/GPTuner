...
- [DB-BERT SIGMOD'22](): a DBMS tuning tool that uses BERT to read the manuals and use the gained information to guide reinforcement learning
- SMAC: the best Bayesian Optimiztion (BO)-based method evaluated in an [Experimental Evaluation ]
- GP
- DDPG++
