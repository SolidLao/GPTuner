...
### Step 2: Install [BenchBase](https://github.com/cmu-db/benchbase) with our script, which is tested on :
- Note: the script is tested on `openjdk version "17.0.8.1" 2023-08-24`
```
cd ./scripts
